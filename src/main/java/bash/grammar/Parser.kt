...
import bash.exception.SyntaxException
import bash.ast.*
...
class Parser(private val lexer: Lexer) {
    ...
    private fun wordStarts():Array<Type> = arrayOf(Type.COMMAND_SUBSTITUTION, Type.ARITHMETIC_EXPANSION, Type.LEFT_PARENTHESIS, Type.WORD)
    ...
    private fun redirectionOperators():Array<Type> {
        return arrayOf(Type.LESS, Type.LESS_LESS, Type.GREATER, Type.GREATER_GREATER, Type.LESS_GREATER)
    }
    ...
    private fun pipelineOperators():Array<Type> = arrayOf(Type.OR, Type.AND_AND, Type.OR_OR, Type.OR_AND)
